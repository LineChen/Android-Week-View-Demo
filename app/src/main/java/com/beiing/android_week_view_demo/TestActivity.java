package com.beiing.android_week_view_demo;
...
public class TestActivity extends AppCompatActivity implements WeekView.EventClickListener,
    ...
    private void setupDateTimeInterpreter(final boolean shortDate) {
        mWeekView.setDateTimeInterpreter(new DateTimeInterpreter() {
            ...
            public String interpretDate(Calendar date) {
                SimpleDateFormat weekdayNameFormat = new SimpleDateFormat("EEEE", Locale.CHINA);
